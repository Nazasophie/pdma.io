! function() {
    ...
    var de = Et.f,
        ...
        Ve = function(t) {
            ...
            return !(this === ke && K(Ne, t) && !K(Ie, t)) && (!(e || !K(this, t) || !K(Ne, t) || K(this, ge) && this[ge][t]) || e)
        },
        ze = function(t, e) {
            t = W(t);
            e = f(e, !0);
        ...
        Qe = function(t) {
            for (var e, r = Te(W(t)), n = [], i = 0; r.length > i;) K(Ne, e = r[i++]) || K(it, e) || n.push(e);
            return n
        },
        He = function(t) {
            for (var e, r = t === ke, n = Te(r ? Ie : W(t)), i = [], o = 0; n.length > o;) !K(Ne, e = n[o++]) || r && !K(ke, e) || i.push(Ne[e]);
            return i
        };
    if (!P) {
        pt((Ae = function() {
...
! function(t) {
    ...
    nhqU: function(t, e, r) {
        ...
        const E = "data-hsjs-portal",
            T = "data-hsjs-env",
            A = "data-hsjs-hublet",
            O = "Cannot identify portalId of loaded script. No elements matching `script[data-hsjs-portal]` found on page.",
        ...
        class Ce {
            ...
            bindToWindow(t = [], e = []) {
                t.length < 1 ? console.warn("You need to specify allowlisted domains when binding to window errors or you will catch all page errors") : window.onerror = (r, n, i, o, s) => {
                    n && Oe(t, n) && !Oe(e, s.message) && "script error" !== r.toLowerCase() && this.sendReport("error", r, n, s)
                }
            }
            report(t, e, r = {}) {
                if (t) {
        ...
        class Cr {
            ...
            isSecurityCode() {
                if (this.getLowerCased(wr.LABEL).indexOf(Or) > -1 && /^\d{3,4}$/.test(this.get(wr.VALUE))) {
        ...
        class mn {
            ...
            createSubmissionContactFieldsFromSubmissionFields(t) {
                ...
                return Object.assign({}, t, {
                    submissionContactFields: r.setEmailField(Dr.findBest(e)).setFirstNameField(Hr.findBest(e)).setLastNameField(Yr.findBest(e)).setPhoneNumberField(sn.findBest(e))
                })
            }
        ...
        class gn {
            ...
            buildSubmission(t) {
                ...
                return bn.build(e, r).then(e => Object.assign({}, t, {
                    submission: e
                }))
            }
            buildSubmissionFromForm(t, e) {
                p("Submission event on: ", t);
                return this.getState(t, e).then(this.scrapeForm).then(Re(({
                    formData: t
                }) => p("Scraped form: ", t))).then(this.buildSubmission).then(Re(({
                    submission: t
